...
public class BottomActionView extends LinearLayout {
    ...
    public void Onclick1(View.OnClickListener listener){
        bottom_img1.setOnClickListener(listener);
    }

    public void Onclick2(View.OnClickListener listener){
        bottom_img2.setOnClickListener(listener);
    }

    public void Onclick3(View.OnClickListener listener){
        bottom_img3.setOnClickListener(listener);
    }

    public void Onclick4(View.OnClickListener listener){
        bottom_img4.setOnClickListener(listener);
    }

    public void Onclick5(View.OnClickListener listener){
