...
public class DefaultXmppFriendImpl implements IXmppFriend {
    ...
    public boolean addFriend(String userName, String name) {
        ...
        try {
            ...
            Roster.getInstanceFor(XmppManager.getInstance().getConnection()).createEntry(JidCreate.bareFrom(userName), name, null);
    ...
    public boolean addFriend(String userName, String name, String groupName) {
        ...
        try {
            ...
            Roster.getInstanceFor(XmppManager.getInstance().getConnection()).createEntry(JidCreate
                            .bareFrom(userName), name,
